...
GO
ALTER TABLE [dbo].[INSCRITO]
    ADD CONSTRAINT [FK_INSCRITO_Curso] FOREIGN KEY ([COD]) REFERENCES [dbo].[CURSOS] ([COD]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8adb30f6-8f62-4806-8920-0ea83e1ab45b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8adb30f6-8f62-4806-8920-0ea83e1ab45b')
