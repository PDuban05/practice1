/*
Script de implementación para DBPrac2
...
GO
:setvar DatabaseName "DBPrac2"
:setvar DefaultFilePrefix "DBPrac2"
...
GO
PRINT N'Creando Tabla [dbo].[AGENTS]...';
...
CREATE TABLE [dbo].[AGENTS] (
    ...
    CONSTRAINT [PK_AGENTS] PRIMARY KEY CLUSTERED ([AGENT_CODE] ASC)
);
...
CREATE TABLE [dbo].[CUSTOMER] (
    ...
    CONSTRAINT [PK_CUSTOMER] PRIMARY KEY CLUSTERED ([CUST_CODE] ASC),
    UNIQUE NONCLUSTERED ([AGENT_CODE] ASC)
);
...
CREATE TABLE [dbo].[ORDERS] (
    ...
    CONSTRAINT [PK_ORDERS] PRIMARY KEY CLUSTERED ([ORD_NUM] ASC),
    UNIQUE NONCLUSTERED ([AGENT_CODE] ASC),
    UNIQUE NONCLUSTERED ([CUST_CODE] ASC)
);


GO
PRINT N'Creando Clave externa [dbo].[FK_AGENTS_CUSTOMER]...';


GO
ALTER TABLE [dbo].[AGENTS]
    ADD CONSTRAINT [FK_AGENTS_CUSTOMER] FOREIGN KEY ([AGENT_CODE]) REFERENCES [dbo].[CUSTOMER] ([AGENT_CODE]);


GO
PRINT N'Creando Clave externa [dbo].[FK_AGENTS_ORDERS]...';


GO
ALTER TABLE [dbo].[AGENTS]
    ADD CONSTRAINT [FK_AGENTS_ORDERS] FOREIGN KEY ([AGENT_CODE]) REFERENCES [dbo].[ORDERS] ([AGENT_CODE]);


GO
PRINT N'Creando Clave externa [dbo].[FK_CUSTOMER_ORDERS]...';


GO
ALTER TABLE [dbo].[CUSTOMER]
    ADD CONSTRAINT [FK_CUSTOMER_ORDERS] FOREIGN KEY ([CUST_CODE]) REFERENCES [dbo].[ORDERS] ([CUST_CODE]) ON DELETE CASCADE;
